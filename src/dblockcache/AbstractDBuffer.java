...
public abstract class AbstractDBuffer {
	protected byte[] _buffer;
	protected boolean _isBusy = false;	// accessed by another thread/not
	protected boolean _isClean = true;	// write is left in cache (dirty)/not (clean)
	protected boolean _isValid = false; // initialized & has valid data/not
	protected int _blockID;
	protected VirtualDisk _virtualDisk;
	
	public AbstractDBuffer(VirtualDisk virtualDisk, int blockID) {
