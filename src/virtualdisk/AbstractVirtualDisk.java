...
public abstract class AbstractVirtualDisk implements IVirtualDisk, Runnable {
	...
	protected Queue<VirtualDiskRequest> _requestQueue = new LinkedList<VirtualDiskRequest>();
	protected Thread _requestManager;

	/*
	 * VirtualDisk Constructors
	 */
	public AbstractVirtualDisk(String volName, boolean format) throws FileNotFoundException,
			IOException {
		...
		_requestManager = new Thread(this);
	...
	public AbstractVirtualDisk() throws FileNotFoundException,
	IOException {
